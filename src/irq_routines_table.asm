...
irq_routines_table:
        ...
        IRQ_CALL irq_routine_row_light - 4, DMCFREQ_IRQ_RATE84
        IRQ_CALL irq_routine_row_dark - 0, DMCFREQ_IRQ_RATE72
        IRQ_CALL irq_routine_row_light - 0, DMCFREQ_IRQ_RATE72
        IRQ_CALL irq_routine_row_dark - 4, DMCFREQ_IRQ_RATE84
        IRQ_CALL irq_routine_row_light - 0, DMCFREQ_IRQ_RATE72
        IRQ_CALL irq_routine_row_dark - 0, DMCFREQ_IRQ_RATE72
        IRQ_CALL irq_routine_row_light - 4, DMCFREQ_IRQ_RATE84
        IRQ_CALL irq_routine_row_dark - 0, DMCFREQ_IRQ_RATE72
