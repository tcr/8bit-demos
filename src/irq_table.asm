...
table_irq_frame_0:
        ...
        IRQ_CALL irq_blank_exit,    DMCFREQ_IRQ_RATE190,    DMCFREQ_IRQ_RATE54

        align 16
table_irq_frame_1:
        IRQ_CALL irq_blank_enter,   DMCFREQ_IRQ_RATE380
        IRQ_CALL irq_set_rate,      DMCFREQ_IRQ_RATE226
        IRQ_CALL irq_set_rate,      DMCFREQ_IRQ_RATE106
        IRQ_CALL irq_blank_exit,    DMCFREQ_IRQ_RATE72,     DMCFREQ_IRQ_RATE54
...
table_irq_frame_3:
        ...
        IRQ_CALL irq_blank_exit,    DMCFREQ_IRQ_RATE54,     DMCFREQ_IRQ_RATE54
