...
iram_tile_compute_end       equ 033h
iram_rewrite_start          equ 034h
iram_rewrite_end            equ 037h
iram_vblank_bkp_a           equ 038h
iram_vblank_bkp_p1          equ 039h
...
TIMING_VDC_WRITE_PADDING        equ 4
...
myvsyncirq
    ...
    .setup_frame:
        ...
        ; set grid+background color
        mov	r0,#vdc_color
        mov	a,#col_grd_black | col_bck_green
        movx	@r0,a
...
compute_chars:
        ...
        compute_char_macro mov
        compute_char_macro mov
        ; for the last precompute, we want the 11th char since we don't populate the 10th here
        inc r1
        compute_char_macro mov
        inc r1
...
EXTRAM_SCORE            equ 0x62
; EXTRAM_APPLE_X          equ 0x62
; EXTRAM_APPLE_Y          equ 0x63
EXTRAM_SNAKE_START_X    equ 0x64
EXTRAM_SNAKE_START_Y    equ 0x65
EXTRAM_SNAKE_START_DIR  equ 0x66
EXTRAM_SNAKE_END_X      equ 0x67
EXTRAM_SNAKE_END_Y      equ 0x68
EXTRAM_SNAKE_END_DIR    equ 0x69
EXTRAM_FRAME            equ 0x6a
